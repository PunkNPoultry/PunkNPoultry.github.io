---
layout: post
title: What to expect when you're expecting a homestead
author: Tracy
description: When you move out to the country, you don't always realize how much the little things will change. We certainly didn't. We knew about the obvious - a longer drive to get to the nearest grocery store, an obvious lack of movie theaters, craft beer not even existing within 20 miles.
tag:
- eggs
- garden
- life on the farm
---
When you move out to the country, you don't always realize how much the little things will change. We certainly didn't. We knew about the obvious - a longer drive to get to the nearest grocery store, an obvious lack of movie theaters, craft beer not even existing within 20 miles. But here's a few tips to the things that we didn't expect. Hope they help you a little before (or maybe even during) your move to rural life. 

## Holidays will change

Especially gift-giving ones like Christmas or Valentines Day. Shirts, ties, jewelry - all of these things will give way to claw hammers, incubators, cutlery and subscriptions to [GRIT magazine](https://www.grit.com/){:target="_blank"}.

For Christmas this year, my husband got pork. Not "porked" (get your mind out of the gutter.) PORK. As in belly meat and bacon from a [Mangalitsa pig](https://www.mangalitsaestates.com/){:target="_blank"}. There is also a very good reason why I would buy my husband parts of a dead animal for Christmas.
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/2337433_orig.jpg", alt: "Big grub", caption: "See this?")%>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/7819812e2c0.jpg", alt: "Chicken poop")%>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/5226010_orig.jpg", alt:"rag rug")%>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/3082318_orig.jpg", alt: "metal grate")%>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/6241512_orig.jpg", alt: "FFBoy and FFGirl stomping in mud")%>
Which then leads to this:
{% include figure.html src="/images/uploads/6/6/5/1/66510973/7533103_orig.jpg" alt="Filthy clothes" %}
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/7533103_orig.jpg", alt: "Filthy clothes")%>
...
Any of these things can be found in a pocket, so when you do laundry - YOU HAVE BEEN WARNED.
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/717012_orig.jpg", alt: "fresh eggs cooking in a skillet")%>

The kids seem to agree, as they don't even order them the few times we go out to eat. For FFarmer, I suspect it's tomatoes.

<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/9771736_orig.jpg", alt: "basket full of tomatoes")%>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/7906502_orig.jpg", alt: "newborn mice") %>
...
Yesterday, our FFBoy helped FF clean out the chicken coop. We do a once-a-year extensive clean out, as we're doing the [deep litter method](https://www.fresheggsdaily.blog/2012/02/deep-litter-methodcoop-cleaning.html){:target="_blank"} in the coop.

Today the kids helped paint a few baskets and picture frames. Did they make a complete mess? Yep. Did I have to go back behind them and repaint? Yep. Was it worth it? Yep. Keeping them busy meant we had time to get a lot done. And even though I still went back and did some touch-up, they did most of the painting work.
