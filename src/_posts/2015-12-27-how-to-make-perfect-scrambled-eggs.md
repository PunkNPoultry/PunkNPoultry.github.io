...
author: Tracy
description: Because we have lots of poultry, we eat a lot of eggs. Fried, poached, hard-boiled, soft-boiled, omelets, over easy, sunnyside up. There are tons of ways to prepare an egg, but arguably the simplest is to scramble it.
tag:
- recipes
- eggs
---
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/5734441_orig.jpg", caption: "butter melting in frying pan") %>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/1692591_orig.jpg", caption: "eggs in a bowl") %>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/9712425_orig.jpg", caption: "eggs and cream") %>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/88112334ffc.jpg", caption: "adding paprika to eggs and cream") %>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/123273_orig.jpg", caption: "beaten eggs") %>
...
<%= render Figure.new(src: "/images/uploads/6/6/5/1/66510973/8946532_orig.jpg", alt: "eggs in pan") %>
...
<%= render YoutubeVideo.new(id: "16SKDJ0LKi8") %>
